                ...
                <ul class="contact-list d-flex flex-wrap align-items-center list-unstyled mb-0">
                  <li class="miniPopup-language-area">
                    ...
                    <ul class="miniPopup miniPopup-language list-unstyled">
                      ...
                      <li>
                        <button>
                          <img src="{{ URL::to('website/assets/images/flags/th.png') }}" height="23px" width="35px" alt="th">
                          <span>Thai</span>
                        </button>
                      </li>
                      <li>
                        <button>
                          <img src="{{ URL::to('website/assets/images/flags/kh.png') }}" height="23px" width="35px" alt="kh">
                          <span>Khmer</span>
                        </button>
                      </li>
                  ...
                  <li>
                    <i class="icon-phone"></i><a href="tel:+5565454117">Emergency Line: (855) 69861400</a>
                  </li>
                  <li>
                    <i class="icon-location"></i><a href="#">Beer City Poipet Zone 3</a>
                  </li>
                  <li>
                    <i class="icon-clock"></i><a href="contact-us.html">Opening Hours: 24*7</a>
                  </li>
                </ul><!-- /.contact-list -->
                <div class="d-flex">
      ...
      <nav class="navbar navbar-expand-lg sticky-navbar">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-center" id="mainNavigation">
            <ul class="navbar-nav">
              <li class="nav-item"><a href="/" wire:navigate class="nav-item-link active">Home</a></li><!-- /.nav-item -->
              <li class="nav-item"><a href="/about" wire:navigate class="nav-item-link">About Us</a></li><!-- /.nav-item -->
              <li class="nav-item"><a href="/events" wire:navigate class="nav-item-link">Events</a></li><!-- /.nav-item -->
              <li class="nav-item"><a href="/login" wire:navigate class="nav-item-link">Membership Login</a></li><!-- /.nav-item -->
              <li class="nav-item"><a href="/register" wire:navigate class="nav-item-link">Sign Us</a></li><!-- /.nav-item -->
              <li class="nav-item"><a href="/contact" wire:navigate class="nav-item-link">Contacts</a></li><!-- /.nav-item -->
            </ul><!-- /.navbar-nav -->
          ...
          <div class="d-none d-xl-flex align-items-center position-relative ml-30">
            <div class="contact-phone d-flex align-items-center">
              ...
              <div>
                ...
                <a class="phone-link d-block" href="tel:00201061245741">+855 06124574</a>
              </div>
            </div>
          </div>
        </div><!-- /.container -->
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6">
              <div class="footer-widget-contact">
                ...
                <p>We always provide 100% customer satisfaction and absolute quality without any compromise.</p>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="footer-widget-nav">
                <h6 class="footer-widget-title">About Gcon</h6>
                <nav>
                  <ul class="list-unstyled">
                    <li><a href="about-us.html">About Us</a></li>
                    <li><a href="team.html">Membership Team</a></li>
                    <li><a href="blog.html">News & Media</a></li>
                    <li><a href="services.html">Upcomming Events</a></li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="footer-widget-nav">
                  ...
                  <nav>
                    <ul class="list-unstyled">
                      <li><a href="careers.html">Contact with Grand Diamond</a></li>
                      <li><a href="careers.html">Popular Festivals</a></li>
                      <li><a href="careers.html">Careers option</a></li>
                    </ul>
                  </nav>
                  <div class="d-flex">
                    <ul class="social-icons list-unstyled mb-0 mr-30">
